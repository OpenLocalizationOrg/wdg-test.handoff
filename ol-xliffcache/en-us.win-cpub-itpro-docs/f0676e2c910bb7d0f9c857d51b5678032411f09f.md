...
ms.openlocfilehash: f0676e2c910bb7d0f9c857d51b5678032411f09f
...
## Windows Defender client error codes If Windows Defender experiences any issues it will usually give you an error code to help you troubleshoot the issue. Most often an error means there was a problem installing an update.
This section provides the following information about Windows Defender client errors.
-   The error code -   The possible reason for the error -   Advice on what to do now Use the information in these tables to help troubleshoot Windows Defender error codes.
<table>
<tr>
...
<td>
<p>This error indicates that there might be an engine configuration error; commonly, this is related to input data that does not allow the engine to function properly. 
</p>
</td>
</tr>
<tr>
...
<td>
<p>Run Windows Defender Offline. You can read about how to do this in the <a href="http://windows.microsoft.com/windows/what-is-windows-defender-offline">Windows Defender Offline article</a>.</p>
</td>
</tr>
<tr>
<td>
